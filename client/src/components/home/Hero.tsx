...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-[100vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-30 pt-20 pb-16 md:pt-28 md:pb-20">
        {/* Experience badge */}
        <motion.div 
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="inline-flex items-center px-4 py-2 rounded-full bg-transparent border border-gold/50 mb-6 max-w-fit"
        >
          ...
          <span className="text-gold font-medium">{companyInfo.experience} years of Trusted Excellence</span>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <motion.h1 
              className="text-4xl sm:text-5xl md:text-6xl font-montserrat font-bold text-white leading-tight mb-6"
            ...
            >
              <Link href="/services">
                <Button className="bg-gold hover:bg-gold/90 text-navy-dark font-bold px-8 py-3 rounded transform transition-all duration-300 hover:scale-105 hover:shadow-lg w-full sm:w-auto">
                  Our Services
                </Button>
              </Link>
              <Link href="/contact">
                <Button variant="outline" className="border-2 border-white/80 text-white font-bold px-8 py-3 rounded bg-transparent hover:bg-white/10 transition-all duration-300 hover:border-gold hover:text-gold w-full sm:w-auto">
                  Contact Us
                </Button>
              </Link>
            </motion.div>
          ...
          <div className="order-1 lg:order-2 relative">
            <motion.div 
              className="relative rounded-2xl overflow-hidden shadow-2xl mb-6 lg:mb-0"
            ...
            >
              ...
              {/* Floating Stats Card */}
              <motion.div 
                className="absolute -bottom-5 -left-5 md:bottom-5 md:left-5 bg-white rounded-lg shadow-xl p-4 border border-white/20 max-w-[160px]"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.6 }}
              >
                <div className="flex items-center">
                  <div className="bg-navy rounded-full p-2 mr-3">
                  ...
                  <div>
                    <h3 className="font-montserrat font-bold text-navy-dark text-base">Trusted Since</h3>
        ...
        <motion.div 
          className="absolute left-1/2 -translate-x-1/2 bottom-6 flex flex-col items-center cursor-pointer"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
