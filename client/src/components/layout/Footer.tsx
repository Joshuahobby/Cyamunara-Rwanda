...
import { navLinks, servicesOverview, companyInfo } from "@/lib/constants";
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-8 md:mb-0">
            ...
            <div className="flex space-x-4">
              <a href={companyInfo.social.facebook} className="text-white hover:text-gold transition-300" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-4 h-4 fill-current">
                  <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
                </svg>
              </a>
              <a href={companyInfo.social.twitter} className="text-white hover:text-gold transition-300" aria-label="Twitter">
              ...
              <a href={companyInfo.social.linkedin} className="text-white hover:text-gold transition-300" aria-label="LinkedIn">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center md:text-left md:flex md:justify-between">
          <p className="opacity-80">
            &copy; {new Date().getFullYear()} Cyamunara Rwanda Ltd. All rights reserved.
          </p>
