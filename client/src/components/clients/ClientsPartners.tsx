...
const ClientsPartners = ({ showAll = false }: ClientsPartnersProps) => {
  ...
  return (
    <div>
      ...
      >
        <h2 className="text-3xl font-montserrat font-bold text-navy-dark mb-4">
        ...
        <p className="mt-2 text-sm text-medium-gray font-medium">
          {clients.length}+ organizations trust Cyamunara Rwanda
        </p>
      </motion.div>
  ...
  const iconMap: { [key: string]: JSX.Element } = {
    ...
    truck: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 2h8l2-2zM13 8h3l3 3v5h-2m-4-8v8" />
      </svg>
    ),
    university: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
